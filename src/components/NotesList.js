    ...
    return (
        <div>
            <form onSubmit={handleSubmit}>
                ...
                <textarea onChange={(e) => setPost({...post, comments: {user: post.comments.user, text: e.target.value}})} value={post.comments.text} placeholder="Enter comments" style={{borderRadius: "20px", marginLeft: "35px", width: "40%", height: "80px"}}/><br/><br/>
                <button type="submit" style={{width: "20%", backgroundColor: "green", color: "white", borderRadius: "20px"}}>Submit</button>
                </form>
                </div>
                )
                }
